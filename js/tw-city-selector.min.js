!(function(t, e) {
      ...
      function() {
        if (this.options.el)
          return (
            ...
            (this.elCounty = i(this.options.elCounty, this.el)),
    ...
    return (
      function() {
        ...
        if (
          ((this.elCounty.innerHTML = function() {
            for (
              var t = '<option value="" disabled>選擇縣市</option>',
                e = function() {
      ...
      this.options.bootstrapStyle &&
        function() {
          ...
          var n = e.cloneNode();
          n.appendChild(this.elDistrict), t.appendChild(n);
          var o = e.cloneNode();
  ...
  function n(t) {
    ...
    for (
      var e = '<option value="" disabled>選擇區域</option>',
        ...
        n = function(t) {
          ...
          return (
            e.forEach(function(e) {
              if (-1 !== e.indexOf(t)) {
                var n = e.lastIndexOf("@");
                return -1 !== n ? (i = e.substring(n + 1).split("|")) : void 0;
              }
            }),
            i
          );
        ...
        s = 0,
        l = o.districts[t][0].length - 1;
      s <= l;
      s++
    )
      (n && -1 === n.indexOf(o.districts[t][0][s])) ||
        (e +=
          '<option value="' +
          o.districts[t][0][s] +
          '"\n                              data-zipcode="' +
